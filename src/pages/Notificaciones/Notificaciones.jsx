...
function Btn({ children, onClick, variant = "primary", size = "md", loading, disabled, type = "button", form, className = "" }) {
  ...
  return (
    <button type={type} form={form} onClick={onClick} disabled={disabled || loading} className={`${base} ${sizes[size]} ${variants[variant]} ${className}`}>
